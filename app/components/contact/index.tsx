...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    window.location.href = `mailto:frhn.r3@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(body)}`;
  };

  return (
    <section
      className="w-full bg-white flex flex-col items-center justify-center py-24 px-6 dark:bg-background transition-colors duration-300 ease-in-out"
      id="contact"
    >
      <div className="max-w-7xl w-full flex flex-col lg:flex-row gap-16 lg:gap-8 items-start justify-between">
        ...
        >
          ...
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-extrabold leading-tight text-slate-900 dark:text-white mb-6">
            Got a cool idea? <br /> Let&apos;s build something sick together 🔥
          </h2>
          <p className="text-lg text-slate-500 dark:text-slate-400 mb-8 leading-relaxed max-w-md">
        ...
        >
          ...
          <form
            ...
            className="w-full md:w-2/3 bg-white dark:bg-card border border-slate-200 dark:border-slate-800 rounded-3xl p-8 shadow-sm flex flex-col gap-6"
          >
            ...
            <button
              type="submit"
              className="w-full bg-primary text-white font-bold text-lg px-8 py-4 rounded-xl shadow-lg shadow-orange-500/30 hover:bg-primary/90 transition-all active:scale-[0.98] flex items-center justify-center gap-2"
            >
