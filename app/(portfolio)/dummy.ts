...
export const EXPERIENCE = [
  {
    ...
    type: "Full-time",
    description:
      "Memimpin tim frontend dalam pengembangan aplikasi SaaS skala besar menggunakan React dan TypeScript.",
  ...
  },
  {
    ...
    type: "Contract",
    description:
      "Mendesain antarmuka pengguna untuk klien internasional, fokus pada aksesibilitas dan sistem desain.",
  ...
  },
  {
    ...
    type: "Full-time",
    description:
      "Mengembangkan landing page responsif dan memelihara website perusahaan.",
