...
import { Award, Briefcase, ChevronRight, Layers, Menu, X } from "lucide-react";
...
const NavButton = ({ children, active, onClick, icon, url }: NavButtonProps) => {
  return (
    <Link
      href={url}
