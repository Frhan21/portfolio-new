...
export const metadata: Metadata = {
  title: 'Not Found',
  description: 'Halaman Not Found | Dashboard Portfolio',
};
      ...
      <div className="flex flex-col items-center justify-center min-h-screen bg-gray-50 text-gray-800 p-4 font-['Montserrat']font-sans">
        <div className="text-center max-w-lg w-full">
          ...
          <p className="text-md text-gray-500 mb-8 max-w-md mx-auto">
            Kami sedang bekerja keras untuk menyajikan konten-konten terbaru
            yang menarik. Mohon bersabar dan nantikan kejutan dari kami!
          </p>
